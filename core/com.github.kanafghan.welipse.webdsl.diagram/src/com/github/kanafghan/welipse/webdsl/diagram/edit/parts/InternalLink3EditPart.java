...
import com.github.kanafghan.welipse.webdsl.diagram.edit.policies.InternalLink3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class InternalLink3EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public InternalLink3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new InternalLink3ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof InternalLinkName3EditPart) {
			((InternalLinkName3EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureInternalLinkNameFigure());
			return true;
		}
		if (childEditPart instanceof InternalLinkInternalLinkSourceCompartment2EditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureInternalLinkSourceCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((InternalLinkInternalLinkSourceCompartment2EditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof InternalLinkInternalLinkActualParametersCompartment2EditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureInternalLinkActualParametersCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((InternalLinkInternalLinkActualParametersCompartment2EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof InternalLinkInternalLinkSourceCompartment2EditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureInternalLinkSourceCompartmentFigure();
			pane.remove(((InternalLinkInternalLinkSourceCompartment2EditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof InternalLinkInternalLinkActualParametersCompartment2EditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureInternalLinkActualParametersCompartmentFigure();
			pane.remove(((InternalLinkInternalLinkActualParametersCompartment2EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof com.github.kanafghan.welipse.webdsl.diagram.edit.parts.InternalLink3EditPart) {
			types.add(WebdslElementTypes.InternalLinkTarget_4004);
		}
