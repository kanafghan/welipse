...
import com.github.kanafghan.welipse.webdsl.diagram.edit.policies.ImageItemSemanticEditPolicy;
...
public class ImageEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ImageExpressionEditPart) {
			((ImageExpressionEditPart) childEditPart)
