 ...
 * @generated
 */
public class CustomActionValue2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public CustomActionValue2EditPart(View view) {
		super(view);
	}
			...
			parser = WebdslParserProvider
					.getParser(
							...
							WebdslVisualIDRegistry
									.getType(com.github.kanafghan.welipse.webdsl.diagram.edit.parts.CustomActionValue2EditPart.VISUAL_ID));
		}
		return parser;
	}
