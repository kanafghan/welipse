 ...
 * @generated
 */
public class WebdslDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public WebdslDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof WebdslDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((WebdslDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new WebdslDomainNavigatorItem((EObject) objects[i],
