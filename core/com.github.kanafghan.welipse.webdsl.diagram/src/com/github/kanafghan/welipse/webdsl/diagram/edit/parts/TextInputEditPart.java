...
import com.github.kanafghan.welipse.webdsl.diagram.edit.policies.TextInputItemSemanticEditPolicy;
...
public class TextInputEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new TextInputItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TextInputLabelExpressionEditPart) {
			((TextInputLabelExpressionEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureTextInputLabelExpressionFigure());
			return true;
		}
		if (childEditPart instanceof TextInputValueExpressionEditPart) {
			((TextInputValueExpressionEditPart) childEditPart)
					.setLabel(getPrimaryShape()
