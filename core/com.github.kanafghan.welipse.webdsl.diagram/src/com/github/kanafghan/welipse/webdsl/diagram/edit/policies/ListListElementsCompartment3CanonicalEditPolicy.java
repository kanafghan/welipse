 ...
 * @generated
 */
public class ListListElementsCompartment3CanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<WebdslNodeDescriptor> childDescriptors = WebdslDiagramUpdater
				.getListListElementsCompartment_7008SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<WebdslNodeDescriptor> childDescriptors = WebdslDiagramUpdater
				.getListListElementsCompartment_7008SemanticChildren((View) getHost()
						.getModel());
