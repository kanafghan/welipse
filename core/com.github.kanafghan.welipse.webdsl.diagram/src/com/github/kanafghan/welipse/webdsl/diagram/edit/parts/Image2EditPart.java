...
import com.github.kanafghan.welipse.webdsl.diagram.edit.policies.Image2ItemSemanticEditPolicy;
...
public class Image2EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ImageExpression2EditPart) {
			((ImageExpression2EditPart) childEditPart)
