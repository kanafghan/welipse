 ...
 * @generated
 */
public class InternalLinkInternalLinkActualParametersCompartmentCanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<WebdslNodeDescriptor> childDescriptors = WebdslDiagramUpdater
				.getInternalLinkInternalLinkActualParametersCompartment_7011SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<WebdslNodeDescriptor> childDescriptors = WebdslDiagramUpdater
				.getInternalLinkInternalLinkActualParametersCompartment_7011SemanticChildren((View) getHost()
						.getModel());
