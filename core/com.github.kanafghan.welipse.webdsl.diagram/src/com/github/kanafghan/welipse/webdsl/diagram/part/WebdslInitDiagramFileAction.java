 ...
 * @generated
 */
public class WebdslInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new WebdslNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				WebsiteEditPart.MODEL_ID));
		WebdslDiagramEditorUtil
