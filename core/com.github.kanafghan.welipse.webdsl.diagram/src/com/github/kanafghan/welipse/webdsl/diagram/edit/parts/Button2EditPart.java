...
import com.github.kanafghan.welipse.webdsl.diagram.edit.policies.Button2ItemSemanticEditPolicy;
...
public class Button2EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ButtonValue2EditPart) {
			((ButtonValue2EditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureButtonValueFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebdslVisualIDRegistry
				.getType(ButtonValue2EditPart.VISUAL_ID));
	}
	...
	public class ButtonFigure extends RoundedRectangle {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureButtonValueFigure;
		...
		public ButtonFigure() {
			...
			this.setBorder(new MarginBorder(getMapMode().DPtoLP(5),
					getMapMode().DPtoLP(8), getMapMode().DPtoLP(5),
					getMapMode().DPtoLP(8)));
		...
		private void createContents() {
			...
			fFigureButtonValueFigure = new WrappingLabel();

			fFigureButtonValueFigure.setText("<...>");

			this.add(fFigureButtonValueFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureButtonValueFigure() {
			return fFigureButtonValueFigure;
		}
	 ...
	 * @generated
	 */
	static final Color THIS_BORDER = new Color(null, 30, 30, 30);
