 ...
 * @generated
 */
public class ListListElementsCompartment2CanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return WebDSLPackage.eINSTANCE.getList_Elements();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<WebdslNodeDescriptor> childDescriptors = WebdslDiagramUpdater
				.getListListElementsCompartment_7005SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<WebdslNodeDescriptor> childDescriptors = WebdslDiagramUpdater
				.getListListElementsCompartment_7005SemanticChildren((View) getHost()
						.getModel());
