...
import com.github.kanafghan.welipse.webdsl.diagram.edit.policies.Text3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Text3EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Text3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Text3ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TextExpression3EditPart) {
			((TextExpression3EditPart) childEditPart)
