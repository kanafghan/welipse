...
import com.github.kanafghan.welipse.webdsl.diagram.edit.policies.ExternalLink3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ExternalLink3EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ExternalLink3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ExternalLink3ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ExternalLinkName3EditPart) {
			((ExternalLinkName3EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureExternalLinkNameFigure());
			return true;
		}
		if (childEditPart instanceof ExternalLinkTargetExpression2EditPart) {
			((ExternalLinkTargetExpression2EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureExternalLinkTargetExpressionFigure());
			return true;
		}
		if (childEditPart instanceof ExternalLinkExternalLinkSourceCompartment2EditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureExternalLinkSourceCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((ExternalLinkExternalLinkSourceCompartment2EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ExternalLinkExternalLinkSourceCompartment2EditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureExternalLinkSourceCompartmentFigure();
			pane.remove(((ExternalLinkExternalLinkSourceCompartment2EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
