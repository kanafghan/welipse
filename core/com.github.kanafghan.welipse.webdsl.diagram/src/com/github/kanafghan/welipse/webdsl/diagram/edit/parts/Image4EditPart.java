...
import com.github.kanafghan.welipse.webdsl.diagram.edit.policies.Image4ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Image4EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Image4EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Image4ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ImageExpression4EditPart) {
			((ImageExpression4EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureImageExpressionFigure());
			return true;
		}
		return false;
	}
	...
	public class ImageFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureImageExpressionFigure;
		...
		private void createContents() {
			...
			fFigureImageExpressionFigure = new WrappingLabel();

			fFigureImageExpressionFigure.setText("<expression>");

			this.add(fFigureImageExpressionFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureImageExpressionFigure() {
			return fFigureImageExpressionFigure;
		}
