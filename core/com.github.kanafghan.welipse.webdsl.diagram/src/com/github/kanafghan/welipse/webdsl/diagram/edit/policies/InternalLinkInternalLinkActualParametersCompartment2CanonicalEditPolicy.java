 ...
 * @generated
 */
public class InternalLinkInternalLinkActualParametersCompartment2CanonicalEditPolicy
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return WebDSLPackage.eINSTANCE.getInternalLink_ActualParameters();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<WebdslNodeDescriptor> childDescriptors = WebdslDiagramUpdater
				.getInternalLinkInternalLinkActualParametersCompartment_7013SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return ActualParameterEditPart.VISUAL_ID == WebdslVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<WebdslNodeDescriptor> childDescriptors = WebdslDiagramUpdater
				.getInternalLinkInternalLinkActualParametersCompartment_7013SemanticChildren((View) getHost()
						.getModel());
