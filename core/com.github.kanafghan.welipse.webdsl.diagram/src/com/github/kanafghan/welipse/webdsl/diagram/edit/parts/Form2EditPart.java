...
import com.github.kanafghan.welipse.webdsl.diagram.edit.policies.Form2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Form2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Form2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Form2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof FormName2EditPart) {
			((FormName2EditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureFormNameFigure());
			return true;
		}
		if (childEditPart instanceof FormFormElementsCompartment2EditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureFormElementsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((FormFormElementsCompartment2EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof FormFormElementsCompartment2EditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureFormElementsCompartmentFigure();
			pane.remove(((FormFormElementsCompartment2EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebdslVisualIDRegistry
				.getType(FormName2EditPart.VISUAL_ID));
	}
