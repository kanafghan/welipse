...
import com.github.kanafghan.welipse.webdsl.diagram.edit.policies.Text2ItemSemanticEditPolicy;
...
public class Text2EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Text2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TextExpression2EditPart) {
			((TextExpression2EditPart) childEditPart)
