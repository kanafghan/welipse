 ...
 * @generated
 */
public class InternalLinkInternalLinkActualParametersCompartment3CanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<WebdslNodeDescriptor> childDescriptors = WebdslDiagramUpdater
				.getInternalLinkInternalLinkActualParametersCompartment_7015SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<WebdslNodeDescriptor> childDescriptors = WebdslDiagramUpdater
				.getInternalLinkInternalLinkActualParametersCompartment_7015SemanticChildren((View) getHost()
						.getModel());
