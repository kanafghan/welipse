...
import com.github.kanafghan.welipse.webdsl.diagram.edit.policies.Group3ItemSemanticEditPolicy;
...
public class Group3EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Group3ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof GroupName3EditPart) {
			((GroupName3EditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureGroupNameFigure());
			return true;
		}
		if (childEditPart instanceof GroupGroupElementsCompartment3EditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureGroupElementsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((GroupGroupElementsCompartment3EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof GroupGroupElementsCompartment3EditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureGroupElementsCompartmentFigure();
			pane.remove(((GroupGroupElementsCompartment3EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebdslVisualIDRegistry
				.getType(GroupName3EditPart.VISUAL_ID));
	}
