 ...
 * @generated
 */
public class FormFormElementsCompartment2CanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<WebdslNodeDescriptor> childDescriptors = WebdslDiagramUpdater
				.getFormFormElementsCompartment_7020SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return Text3EditPart.VISUAL_ID == WebdslVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<WebdslNodeDescriptor> childDescriptors = WebdslDiagramUpdater
				.getFormFormElementsCompartment_7020SemanticChildren((View) getHost()
						.getModel());
