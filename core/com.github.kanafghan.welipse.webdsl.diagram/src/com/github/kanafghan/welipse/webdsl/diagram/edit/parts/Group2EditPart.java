...
import com.github.kanafghan.welipse.webdsl.diagram.edit.policies.Group2ItemSemanticEditPolicy;
...
public class Group2EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof GroupGroupElementsCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureGroupElementsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((GroupGroupElementsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof GroupGroupElementsCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureGroupElementsCompartmentFigure();
			pane.remove(((GroupGroupElementsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
