...
import com.github.kanafghan.welipse.webdsl.diagram.edit.policies.TextItemSemanticEditPolicy;
...
public class TextEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TextExpressionEditPart) {
			((TextExpressionEditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureTextExpressionFigure());
			return true;
		}
		return false;
	}
