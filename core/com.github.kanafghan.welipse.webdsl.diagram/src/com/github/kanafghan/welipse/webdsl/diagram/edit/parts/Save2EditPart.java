...
import com.github.kanafghan.welipse.webdsl.diagram.edit.policies.Save2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Save2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Save2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Save2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SaveValue2EditPart) {
			((SaveValue2EditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureSaveValueFigure());
			return true;
		}
		if (childEditPart instanceof SavePerformerExpression2EditPart) {
			((SavePerformerExpression2EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureSavePerformerExpression());
			return true;
		}
		if (childEditPart instanceof SaveValidatorExpression2EditPart) {
			((SaveValidatorExpression2EditPart) childEditPart)
					.setLabel(getPrimaryShape()
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebdslVisualIDRegistry
				.getType(SaveValue2EditPart.VISUAL_ID));
	}
