 ...
 * @generated
 */
public class ButtonValue2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ButtonValue2EditPart(View view) {
		super(view);
	}
			...
			parser = WebdslParserProvider
					.getParser(
							...
							WebdslVisualIDRegistry
									.getType(com.github.kanafghan.welipse.webdsl.diagram.edit.parts.ButtonValue2EditPart.VISUAL_ID));
		}
		return parser;
	}
