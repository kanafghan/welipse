 ...
 * @generated
 */
public class ListVariableEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ListVariableEditPart(View view) {
		super(view);
	}
			...
			parser = WebdslParserProvider
					.getParser(
							...
							WebdslVisualIDRegistry
									.getType(com.github.kanafghan.welipse.webdsl.diagram.edit.parts.ListVariableEditPart.VISUAL_ID));
		}
		return parser;
	}
