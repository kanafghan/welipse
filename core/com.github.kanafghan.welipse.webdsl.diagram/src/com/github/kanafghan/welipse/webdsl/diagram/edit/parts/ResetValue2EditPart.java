 ...
 * @generated
 */
public class ResetValue2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ResetValue2EditPart(View view) {
		super(view);
	}
			...
			parser = WebdslParserProvider
					.getParser(
							...
							WebdslVisualIDRegistry
									.getType(com.github.kanafghan.welipse.webdsl.diagram.edit.parts.ResetValue2EditPart.VISUAL_ID));
		}
		return parser;
	}
