...
import com.github.kanafghan.welipse.webdsl.diagram.part.WebdslDiagramEditor;
 ...
 * @generated
 */
public class WebdslNavigatorActionProvider extends CommonActionProvider {
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof WebdslNavigatorItem) {
					selectedElement = ((WebdslNavigatorItem) selectedElement)
							.getView();
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, WebdslDiagramEditor.ID);
