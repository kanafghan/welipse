 ...
 * @generated
 */
public class InternalLinkInternalLinkSourceCompartment2CanonicalEditPolicy
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return WebDSLPackage.eINSTANCE.getLink_Source();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<WebdslNodeDescriptor> childDescriptors = WebdslDiagramUpdater
				.getInternalLinkInternalLinkSourceCompartment_7012SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		int visualID = WebdslVisualIDRegistry.getVisualID(view);
		return visualID == Text4EditPart.VISUAL_ID
				|| visualID == Image4EditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<WebdslNodeDescriptor> childDescriptors = WebdslDiagramUpdater
				.getInternalLinkInternalLinkSourceCompartment_7012SemanticChildren((View) getHost()
						.getModel());
