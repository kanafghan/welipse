...
import com.github.kanafghan.welipse.webdsl.diagram.edit.policies.List3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class List3EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public List3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new List3ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ListVariable2EditPart) {
			((ListVariable2EditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureListVariableFigure());
			return true;
		}
		if (childEditPart instanceof ListExpression4EditPart) {
			((ListExpression4EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureListExpressionFigure());
			return true;
		}
		if (childEditPart instanceof ListListElementsCompartment3EditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureListElementsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((ListListElementsCompartment3EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ListListElementsCompartment3EditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureListElementsCompartmentFigure();
			pane.remove(((ListListElementsCompartment3EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
