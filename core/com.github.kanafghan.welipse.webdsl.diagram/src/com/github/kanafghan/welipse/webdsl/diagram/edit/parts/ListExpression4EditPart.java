 ...
 * @generated
 */
public class ListExpression4EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ListExpression4EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = WebdslParserProvider
					.getParser(
							WebdslElementTypes.List_3018,
							getParserElement(),
							WebdslVisualIDRegistry
									.getType(com.github.kanafghan.welipse.webdsl.diagram.edit.parts.ListExpression4EditPart.VISUAL_ID));
		}
		return parser;
	}
