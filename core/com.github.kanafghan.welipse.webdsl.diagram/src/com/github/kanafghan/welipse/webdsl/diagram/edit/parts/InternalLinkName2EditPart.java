 ...
 * @generated
 */
public class InternalLinkName2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public InternalLinkName2EditPart(View view) {
		super(view);
	}
			...
			parser = WebdslParserProvider
					.getParser(
							...
							WebdslVisualIDRegistry
									.getType(com.github.kanafghan.welipse.webdsl.diagram.edit.parts.InternalLinkName2EditPart.VISUAL_ID));
		}
		return parser;
	}
