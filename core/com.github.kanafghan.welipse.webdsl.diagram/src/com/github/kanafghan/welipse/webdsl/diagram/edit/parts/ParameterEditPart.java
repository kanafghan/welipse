...
import com.github.kanafghan.welipse.webdsl.diagram.edit.policies.ParameterItemSemanticEditPolicy;
...
public class ParameterEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ParameterDeclarationEditPart) {
			((ParameterDeclarationEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureParameterDeclarationFigure());
			return true;
		}
		return false;
	}
	...
	public class ParameterFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureParameterDeclarationFigure;
		...
		private void createContents() {
			...
			fFigureParameterDeclarationFigure = new WrappingLabel();

			fFigureParameterDeclarationFigure.setText("<declaration>");

			this.add(fFigureParameterDeclarationFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureParameterDeclarationFigure() {
			return fFigureParameterDeclarationFigure;
		}
