...
import com.github.kanafghan.welipse.webdsl.diagram.edit.policies.Image3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Image3EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Image3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Image3ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ImageExpression3EditPart) {
			((ImageExpression3EditPart) childEditPart)
