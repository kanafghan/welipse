...
import com.github.kanafghan.welipse.webdsl.diagram.edit.policies.WebdslTextSelectionEditPolicy;
 ...
 * @generated
 */
public class SelectionListOptionsExpressionEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public SelectionListOptionsExpressionEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new WebdslTextSelectionEditPolicy());
			...
			parser = WebdslParserProvider
					.getParser(
							...
							WebdslVisualIDRegistry
									.getType(com.github.kanafghan.welipse.webdsl.diagram.edit.parts.SelectionListOptionsExpressionEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					WebdslEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
