 ...
 * @generated
 */
public class ExternalLinkExternalLinkSourceCompartmentCanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<WebdslNodeDescriptor> childDescriptors = WebdslDiagramUpdater
				.getExternalLinkExternalLinkSourceCompartment_7016SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<WebdslNodeDescriptor> childDescriptors = WebdslDiagramUpdater
				.getExternalLinkExternalLinkSourceCompartment_7016SemanticChildren((View) getHost()
						.getModel());
