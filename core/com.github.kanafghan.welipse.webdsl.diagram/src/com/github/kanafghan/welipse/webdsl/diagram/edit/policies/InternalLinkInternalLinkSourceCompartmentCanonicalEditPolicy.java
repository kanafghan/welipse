 ...
 * @generated
 */
public class InternalLinkInternalLinkSourceCompartmentCanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<WebdslNodeDescriptor> childDescriptors = WebdslDiagramUpdater
				.getInternalLinkInternalLinkSourceCompartment_7010SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<WebdslNodeDescriptor> childDescriptors = WebdslDiagramUpdater
				.getInternalLinkInternalLinkSourceCompartment_7010SemanticChildren((View) getHost()
						.getModel());
