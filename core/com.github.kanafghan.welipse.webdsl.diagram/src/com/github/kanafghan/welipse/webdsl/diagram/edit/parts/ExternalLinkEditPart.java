...
import com.github.kanafghan.welipse.webdsl.diagram.edit.policies.ExternalLinkItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ExternalLinkEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ExternalLinkEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ExternalLinkItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ExternalLinkNameEditPart) {
			((ExternalLinkNameEditPart) childEditPart)
		...
		if (childEditPart instanceof ExternalLinkExternalLinkSourceCompartment3EditPart) {
			...
			pane.add(((ExternalLinkExternalLinkSourceCompartment3EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ExternalLinkExternalLinkSourceCompartment3EditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureExternalLinkSourceCompartmentFigure();
			pane.remove(((ExternalLinkExternalLinkSourceCompartment3EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
