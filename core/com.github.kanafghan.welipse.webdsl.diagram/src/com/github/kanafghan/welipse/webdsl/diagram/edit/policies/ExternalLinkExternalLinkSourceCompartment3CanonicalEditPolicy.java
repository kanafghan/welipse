 ...
 * @generated
 */
public class ExternalLinkExternalLinkSourceCompartment3CanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<WebdslNodeDescriptor> childDescriptors = WebdslDiagramUpdater
				.getExternalLinkExternalLinkSourceCompartment_7018SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<WebdslNodeDescriptor> childDescriptors = WebdslDiagramUpdater
				.getExternalLinkExternalLinkSourceCompartment_7018SemanticChildren((View) getHost()
						.getModel());
