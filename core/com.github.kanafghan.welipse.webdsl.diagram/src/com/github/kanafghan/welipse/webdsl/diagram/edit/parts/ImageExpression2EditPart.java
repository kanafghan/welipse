 ...
 * @generated
 */
public class ImageExpression2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ImageExpression2EditPart(View view) {
		super(view);
	}
			...
			parser = WebdslParserProvider
					.getParser(
							...
							WebdslVisualIDRegistry
									.getType(com.github.kanafghan.welipse.webdsl.diagram.edit.parts.ImageExpression2EditPart.VISUAL_ID));
		}
		return parser;
	}
