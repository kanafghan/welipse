 ...
 * @generated
 */
public class PagePageVariablesCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return WebDSLPackage.eINSTANCE.getPage_Variables();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<WebdslNodeDescriptor> childDescriptors = WebdslDiagramUpdater
				.getPagePageVariablesCompartment_7002SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return VariableInitializationEditPart.VISUAL_ID == WebdslVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<WebdslNodeDescriptor> childDescriptors = WebdslDiagramUpdater
				.getPagePageVariablesCompartment_7002SemanticChildren((View) getHost()
						.getModel());
