 ...
 * @generated
 */
public class List3ItemSemanticEditPolicy extends
		WebdslBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public List3ItemSemanticEditPolicy() {
		super(WebdslElementTypes.List_3018);
	}
				...
				for (Iterator<?> cit = node.getChildren().iterator(); cit
					...
					case InternalLink2EditPart.VISUAL_ID:
						...
						for (Iterator<?> it = cnode.getSourceEdges().iterator(); it
							...
							if (WebdslVisualIDRegistry
									.getVisualID(outgoingLink) == InternalLinkTargetEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
