...
import com.github.kanafghan.welipse.webdsl.diagram.edit.policies.Text4ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Text4EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Text4EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Text4ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TextExpression4EditPart) {
			((TextExpression4EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureTextExpressionFigure());
			return true;
		}
		return false;
	}
	 ...
	 * @generated
	 */
	public class TextFigure extends RectangleFigure {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureTextExpressionFigure;
		...
		private void createContents() {
			...
			fFigureTextExpressionFigure = new WrappingLabel();

			fFigureTextExpressionFigure.setText("<expression>");

			this.add(fFigureTextExpressionFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureTextExpressionFigure() {
			return fFigureTextExpressionFigure;
		}
