...
import com.github.kanafghan.welipse.webdsl.diagram.edit.policies.CustomActionItemSemanticEditPolicy;
 ...
 * @generated
 */
public class CustomActionEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public CustomActionEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new CustomActionItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CustomActionValueEditPart) {
			((CustomActionValueEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureCustomActionValueFigure());
			return true;
		}
		if (childEditPart instanceof CustomActionPerformerExpressionEditPart) {
			((CustomActionPerformerExpressionEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureCustomActionPerformerExpression());
			return true;
		}
		if (childEditPart instanceof CustomActionValidatorExpressionEditPart) {
			((CustomActionValidatorExpressionEditPart) childEditPart)
					.setLabel(getPrimaryShape()
