 ...
 * @generated
 */
public class GroupName3EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
			...
			parser = WebdslParserProvider
					.getParser(
							...
							WebdslVisualIDRegistry
									.getType(com.github.kanafghan.welipse.webdsl.diagram.edit.parts.GroupName3EditPart.VISUAL_ID));
		}
		return parser;
	}
