 ...
 * @generated
 */
public class ExternalLinkExternalLinkSourceCompartment2CanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<WebdslNodeDescriptor> childDescriptors = WebdslDiagramUpdater
				.getExternalLinkExternalLinkSourceCompartment_7017SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<WebdslNodeDescriptor> childDescriptors = WebdslDiagramUpdater
				.getExternalLinkExternalLinkSourceCompartment_7017SemanticChildren((View) getHost()
						.getModel());
