...
import com.github.kanafghan.welipse.webdsl.diagram.edit.policies.List2ItemSemanticEditPolicy;
...
public class List2EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new List2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ListVariableEditPart) {
			((ListVariableEditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureListVariableFigure());
			return true;
		}
		if (childEditPart instanceof ListExpression3EditPart) {
			((ListExpression3EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureListExpressionFigure());
			return true;
		}
		if (childEditPart instanceof ListListElementsCompartment2EditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureListElementsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((ListListElementsCompartment2EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ListListElementsCompartment2EditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureListElementsCompartmentFigure();
			pane.remove(((ListListElementsCompartment2EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebdslVisualIDRegistry
				.getType(ListVariableEditPart.VISUAL_ID));
	}
