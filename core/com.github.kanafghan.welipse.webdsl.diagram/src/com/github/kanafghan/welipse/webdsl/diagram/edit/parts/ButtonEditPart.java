...
import com.github.kanafghan.welipse.webdsl.diagram.edit.policies.ButtonItemSemanticEditPolicy;
...
public class ButtonEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ButtonValueEditPart) {
			((ButtonValueEditPart) childEditPart).setLabel(getPrimaryShape()
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebdslVisualIDRegistry
				.getType(ButtonValueEditPart.VISUAL_ID));
	}
