 ...
 * @generated
 */
public abstract class WebdslAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = WebdslDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected WebdslAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
