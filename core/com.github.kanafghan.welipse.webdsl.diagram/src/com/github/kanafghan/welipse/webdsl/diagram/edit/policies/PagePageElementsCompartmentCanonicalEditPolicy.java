 ...
 * @generated
 */
public class PagePageElementsCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return WebDSLPackage.eINSTANCE.getPage_Elements();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<WebdslNodeDescriptor> childDescriptors = WebdslDiagramUpdater
				.getPagePageElementsCompartment_7003SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<WebdslNodeDescriptor> childDescriptors = WebdslDiagramUpdater
				.getPagePageElementsCompartment_7003SemanticChildren((View) getHost()
						.getModel());
