 ...
 * @generated
 */
public class InternalLinkInternalLinkSourceCompartment3CanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<WebdslNodeDescriptor> childDescriptors = WebdslDiagramUpdater
				.getInternalLinkInternalLinkSourceCompartment_7014SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<WebdslNodeDescriptor> childDescriptors = WebdslDiagramUpdater
				.getInternalLinkInternalLinkSourceCompartment_7014SemanticChildren((View) getHost()
						.getModel());
