 ...
 * <!-- end-user-doc -->
 * @see com.github.kanafghan.welipse.webdsl.WebDSLPackage#getComparisonOperator()
 * @model
 * @generated
 */
public enum ComparisonOperator implements Enumerator {
	 ...
	 * @ordered
	 */
	GREATER_THAN_EQUAL(4, "GreaterThanEqual", "GreaterThanEqual"),
	 ...
	 * @ordered
	 */
	LESS_THAN_EQUAL(5, "LessThanEqual", "LessThanEqual");
