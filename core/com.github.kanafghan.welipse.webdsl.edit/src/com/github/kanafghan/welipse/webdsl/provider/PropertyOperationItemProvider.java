...
/**
 * This is the item provider adapter for a {@link com.github.kanafghan.welipse.webdsl.PropertyOperation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PropertyOperationItemProvider
	extends OperationExpItemProvider
	implements
	 ...
	 * @generated
	 */
	public PropertyOperationItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PropertyOperation_identifier_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PropertyOperation_identifier_feature", "_UI_PropertyOperation_type"),
				 WebDSLPackage.Literals.PROPERTY_OPERATION__IDENTIFIER,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WebDSLPackage.Literals.PROPERTY_OPERATION__SOURCE);
		}
	...
	public String getText(Object object) {
		String label = ((PropertyOperation)object).getIdentifier();
		return label == null || label.length() == 0 ?
			getString("_UI_PropertyOperation_type") :
			getString("_UI_PropertyOperation_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PropertyOperation.class)) {
			case WebDSLPackage.PROPERTY_OPERATION__IDENTIFIER:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case WebDSLPackage.PROPERTY_OPERATION__SOURCE:
