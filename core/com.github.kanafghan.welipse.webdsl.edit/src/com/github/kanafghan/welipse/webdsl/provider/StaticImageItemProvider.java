...
/**
 * This is the item provider adapter for a {@link com.github.kanafghan.welipse.webdsl.StaticImage} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StaticImageItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_StaticImage_source_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_StaticImage_source_feature", "_UI_StaticImage_type"),
				 WebDSLPackage.Literals.STATIC_IMAGE__SOURCE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(StaticImage.class)) {
			case WebDSLPackage.STATIC_IMAGE__SOURCE:
